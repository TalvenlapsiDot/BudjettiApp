...
const App = () => {
    ...
    return (
        ...
        <Flex direction='column' justifyContent='center' align='center' height='100%'>
          ...
          {/*Takes Auth-component from Auth.jsx. When user first opens, Auth sets the previous Authenticated hook as FALSE so the user sees the login page.
          This component also handles showing either registration or login pages. */}
